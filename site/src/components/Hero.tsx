        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3" aria-label="Key benefits">
              ...
              <li className="flex items-start gap-3 text-surface-900">
                ...
                <span>Repair / make-safe crew – no decorative pour brochure</span>
              </li>
          ...
          <div className="relative">
            <div className="aspect-[4/3] rounded-lg overflow-hidden shadow-2xl">
              <img
                src="/emergency-driveway-repair-sydney-960.webp"
                srcSet="/emergency-driveway-repair-sydney-640.webp 640w, /emergency-driveway-repair-sydney-960.webp 960w, /emergency-driveway-repair-sydney-1280.webp 1280w, /emergency-driveway-repair-sydney-1584.webp 1584w"
