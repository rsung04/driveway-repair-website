...
export function TermsOfService() {
    ...
    return (
        <div className="min-h-screen bg-white">
            <SEO
                title="Terms of Service | Woollahra Driveway Repairs"
                description="Our specific terms, conditions, and service agreement details for all driveway repair works in Woollahra and surrounding suburbs."
            ...
            <main className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="prose prose-slate max-w-none text-surface-700 space-y-6">
                    ...
                    <p>These terms and conditions outline the rules and regulations for the use of Woollahra Driveway Repairs' Website, located at sydneydrivewayrepair.com.</p>

                    <h2 className="text-xl font-bold text-surface-900 mt-8 mb-4">1. Acceptance of Terms</h2>
                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Woollahra Driveway Repairs if you do not agree to take all of the terms and conditions stated on this page.</p>

                    <h2 className="text-xl font-bold text-surface-900 mt-8 mb-4">2. Services</h2>
                    <p>We provide driveway repair, maintenance, and resurfacing services. All quotes provided are estimates and subject to site inspection. Emergency call-out fees may apply for after-hours services.</p>
                    ...
                    <p>If you require any more information or have any questions about our Terms of Service, please feel free to contact us by email at repairs@woollahra-driveways.com.au.</p>
                </div>
            </main>
            <Footer />
        </div>
