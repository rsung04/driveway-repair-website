...
export function PrivacyPolicy() {
    ...
    return (
        <div className="min-h-screen bg-white">
            <SEO
                title="Privacy Policy | Sydney Driveway Repair"
                description="Our privacy policy outlines how we collect, use, and protect your personal information when you use the Sydney Driveway Repair website."
            ...
            <main className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="prose prose-slate max-w-none text-surface-700 space-y-6">
                    ...
                    <p>At Sydney Driveway Repair, accessed from sydneydrivewayrepair.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Sydney Driveway Repair and how we use it.</p>
                    ...
                    <p>Sydney Driveway Repair follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files includes internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks.</p>

                    <h2 className="text-xl font-bold text-surface-900 mt-8 mb-4">4. Advertising Partners Privacy Policies</h2>
                    <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Sydney Driveway Repair. Third-party ad servers or ad networks use technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on Sydney Driveway Repair, which are sent directly to users' browser.</p>

                    <h2 className="text-xl font-bold text-surface-900 mt-8 mb-4">5. Contact Us</h2>
                    <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at info@sydneydrivewayrepair.com.</p>
                </div>
            </main>
            <Footer />
        </div>
